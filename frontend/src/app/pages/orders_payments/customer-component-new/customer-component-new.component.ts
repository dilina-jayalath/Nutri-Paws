...
@Component({
  selector: 'app-customer-component-new',
  templateUrl: './customer-component-new.component.html',
  styleUrls: ['./customer-component-new.component.scss'],
})
export class CustomerComponentNewComponent {
  constructor(
