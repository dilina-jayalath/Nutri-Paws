...
export class SupplierProfileService {
  ...
  constructor(private http: HttpClient) {}
    ...
    getCustomerByCusId(id: number) {
      ...
      return this.http.get(`${this.url}supplier/getSuppliersByCusId/${id}`, {
        headers,
      });
    }
    ...
    deleteCustomerAcc(id: number) {
      ...
      return this.http.delete(`${this.url}supplier/deleteSuppliers/${id}`, {
        headers,
      });
    }
    // DELETE - FUNCTION OF DELETE CUSTOMER ACCOUNT
    ...
    updateCustomer(userUpdate: any, id: number) {
      ...
      return this.http.put(`${this.url}supplier/updateSuppliers/${id}`, userUpdate, {
        headers,
      });
    }
